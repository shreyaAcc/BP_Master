 ...
 * This is the Test Case which performs Checking the settings section and checking all the menu items by navigating to all the menu items and then checks if Save and Cancel button is present
 * 
 */
...
import BP.SISP.Portal.PortalPages.SettingPage;


public class TC005_NavigateToSettingsAndCheckMenus {
...
//		System.setProperty("Webdriver.chrome.driver","C:/Program Files/Java/chromedriver.exe");
		System.out.println("Launching Chrome");
			caps.setCapability("name","TC005_NavigateToSettingsAndCheckMenus");
...
public void TestLogin() throws Exception
{
   ...
   if(MyAccount.equalsIgnoreCase("AD2 SISPortal"))
   {
	...
	@Test(priority=1)
	public void CheckSettingsPage() throws InterruptedException
	{

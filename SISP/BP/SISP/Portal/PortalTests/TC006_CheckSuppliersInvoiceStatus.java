 ...
 * This is the Test Case which performs various task to Login, Check if It is navigating to correct Page and then check if Search supplier button is enabled and clickable
 * 
 * 
 */
...
import BP.SISP.Portal.PortalPages.SupplierInvoiceStatus;
public class TC006_CheckSuppliersInvoiceStatus {
...
//		System.setProperty("Webdriver.chrome.driver","C:/Program Files/Java/chromedriver.exe");
		System.out.println("Launching Chrome");
			caps.setCapability("name","TC006_CheckSuppliersInvoiceStatus");
...
public void TestLogin() throws Exception
{
   ...
   if(MyAccount.equalsIgnoreCase("AD2 SISPortal"))
   {
	...
	public void SearchInvoice()
	{
		...
		home.ClickOnSuppliersInvoiceStatus();
		SupplierInvoiceStatus sis=new SupplierInvoiceStatus(driver);
		sis.CheckCurrentPage();
		sis.ClickOnSearchOnvoice();
